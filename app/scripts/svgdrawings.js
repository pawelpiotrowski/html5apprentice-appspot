    ...
    function(SvgSource, SvgDrawing) {
        return {
            ...
            link: function(scope, iElement, iAttr) {
                ...
                var buttonColors = scope.getCurrentPalette();
                var buttonMainColor = buttonColors.main;
                var buttonContraColor = buttonColors.contra;
                var buttonSource = SvgSource.flower1(buttonMainColor, buttonContraColor);
                var buttonDrawing = new SvgDrawing(button, buttonSource);
                buttonDrawing.drawsvg();
                console.log(buttonDrawing.paths);
            }
        };
    }
])
...
.service('AppservSvgSource', [
    function() {
        this.flower1 = function(bottomColor, topColor) {
            return {
